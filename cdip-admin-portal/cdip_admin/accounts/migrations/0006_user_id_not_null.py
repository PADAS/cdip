...
'{sentinel_user_username}', '8hgaeio4$im', false, 'Sentinel', 'Sentinel', 'sentinel-user@sintegrate.org', false, false, current_timestamp) on conflict do nothing;
'''
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(ALTER_USER_ID_SET_NOT_NULL, reverse_sql=migrations.RunSQL.noop),
