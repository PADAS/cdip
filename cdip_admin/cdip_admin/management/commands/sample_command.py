...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--some_argument', type=str,
                            help='A sample argument')
        parser.add_argument('--a_date_argument', type=str,
                            help='A date argument')
        parser.add_argument('--some_boolean', action='store_true',
                            help='A sample boolean argument')
