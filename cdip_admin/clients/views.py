...
def client_detail(request, client_id):
    ...
    return render(
        ...
        {"client": client, "organizations": organizations, "profile": profile},
    )
...
def client_profile_add(request, client_id):
    ...
    if request.method == "POST":
        ...
        if profile_form.is_valid():
            ...
            return render(
                request,
                "clients/client_profile_add.html",
                {"client_id": client_id, "profile_form": profile_form},
            )
    ...
    if request.method == "POST":
        ...
        if profile_form.is_valid():
            ...
            return render(
                request,
                "clients/client_profile_add.html",
                {"user_id": client_id, "profile_form": profile_form},
            )
        ...
        return render(
            request,
            "clients/client_profile_update.html",
            {"profile_form": profile_form, "client_id": client_id},
        )
