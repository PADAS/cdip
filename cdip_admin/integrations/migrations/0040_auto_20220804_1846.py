...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='provider',
            field=models.CharField(blank=True, help_text="This value will be used as the 'provider_key' when sending data to EarthRanger.", max_length=200, verbose_name='Provider_key'),
        ),
        migrations.CreateModel(
