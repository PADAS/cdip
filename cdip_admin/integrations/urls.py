...
from . import views
from .views import (
    OutboundIntegrationConfigurationUpdateView,
    InboundIntegrationConfigurationUpdateView,
    DeviceGroupUpdateView,
    InboundIntegrationConfigurationAddView,
    OutboundIntegrationConfigurationAddView,
    DeviceGroupAddView,
    DeviceGroupManagementUpdateView,
    BridgeIntegrationAddView,
...
urlpatterns = [
    ...
    path(
        ...
        InboundIntegrationConfigurationAddView.as_view(),
    ...
    path(
        ...
        OutboundIntegrationConfigurationAddView.as_view(),
    ...
    path(
        "bridges/add", BridgeIntegrationAddView.as_view(), name="bridge_integration_add"
    ),
    path(
